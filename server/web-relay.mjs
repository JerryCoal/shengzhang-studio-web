  ...
  app.post('/api/web/execute', (req, res, next) => {
    ...
    const finish = async (payload, status = 200) => {
      ...
      try {
        ...
        json.call(res.status(200), { status, response: payload, state, credentials: input.credentials.douyin ? { douyin: input.credentials.douyin } : {}, authorizations: [...authorizations] });
